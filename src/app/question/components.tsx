  ...
  return (
    <div className="h-[56px] w-auto px-4 bg-white items-center flex">
      ...
      <div className="flex items-center justify-center flex-1 space-x-[8px]">
        <Image src="/purple_small_chat.svg" alt="chat-logo" width={24} height={24} />
        <h2 className="text-purple-700 text-[20px] font-semibold">아니근데</h2>
      </div>
      <div className="items-center flex justify-self-end px-1">
        <button>
          <Image src="/human_in_circle.svg" alt="list-button" width={20} height={20} />
        </button>
      </div>
    </div>
  );
    ...
    <div className="items-center h-[498px] w-[358px] bg-white justify-center rounded-2xl px-[24px] shadow-md space-y-11">
      <div className="flex-col space-y-[12px]">
        <div className="rounded-full bg-[#FFF599] w-[32px] h-[32px] flex items-center justify-center mx-auto mt-[28px]">
          <Image alt="light-balb" width={16} height={16} src="/light_balb.png" />
        </div>
...
export const BigOButton = () => {
  return (
    <>
      <div className="bg-[#CCE4FF] h-[164px] w-[144px] rounded-md py-[14px]">
        <button className="w-full h-full flex flex-col items-center justify-evenly">
          <Image src="/blue_o.svg" width={72} height={72} alt="o" className="m-[calc(100px - 72px)]" />
...
export const BigXButton = () => {
  return (
    <>
      <div className="bg-[#FFE3E3] h-[164px] w-[144px] rounded-md py-[14px]">
        <button className="w-full h-full flex flex-col items-center justify-evenly">
          <Image src="/red_x.svg" width={66} height={66} alt="x" className="m-[calc(100px - 66px)]" />
